...
:if ([:len [/ip/hotspot/profile find name="hifastlink"]] = 0) do={
    /ip/hotspot/profile add name="hifastlink" dns-name=$DNSName login-page="https://app.{DOMAIN}/login" use-radius=yes login-by="mac-cookie,cookie,http-chap,http-pap" nas-port-type="wireless-802.11" radius-accounting=yes radius-interim-update=00:01:00 http-cookie-lifetime=$HotspotCookieLifetime
} else={
    /ip/hotspot/profile set [find name="hifastlink"] dns-name=$DNSName login-page="https://app.{DOMAIN}/login" use-radius=yes login-by="mac-cookie,cookie,http-chap,http-pap" nas-port-type="wireless-802.11" radius-accounting=yes radius-interim-update=00:01:00 http-cookie-lifetime=$HotspotCookieLifetime
}
...
/ip/hotspot/walled-garden add dst-host="*.whatsapp.net"      comment="WhatsApp Messaging"
/ip/hotspot/walled-garden add dst-host="*.whatsapp.com"      comment="WhatsApp Web"
