    ...
    <div class="grid lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl">
             ...
             <div class="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl">
                <h3 class="text-2xl font-black text-gray-900 dark:text-white mb-6">Recent Transactions</h3>
                        ...
                        <tbody class="text-sm divide-y divide-gray-100 dark:divide-gray-700">
                            @if(isset($recentPayments) && count($recentPayments) > 0)
                                ...
                                <tr class="group hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                    <td class="py-4 text-gray-600 dark:text-gray-300">{{ $payment->created_at->format('d M, h:i A') }}</td>
                                    <td class="py-4 font-bold text-gray-800 dark:text-white">{{ $payment->plan_name }}</td>
                                    <td class="py-4 text-gray-600 dark:text-gray-300">₦{{ number_format($payment->amount) }}</td>
                                    <td class="py-4 text-xs font-mono text-gray-400">{{ substr($payment->reference, 0, 10) }}...</td>
                            ...
                            @else
                                <tr>
                                    <td colspan="5" class="py-6 text-center text-gray-500">No transactions found yet.</td>
                                </tr>
                            @endif
                        </tbody>
                    </table>
